...
CREATE SEQUENCE stock_snapshots_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE stock_snapshots_id_seq OWNED BY stock_snapshots.id;
...
ALTER TABLE ONLY stock_snapshots ALTER COLUMN id SET DEFAULT nextval('stock_snapshots_id_seq'::regclass);
...
ALTER TABLE ONLY stock_snapshots
